...
```{r Set-up R session, eval=TRUE, include=TRUE, results=FALSE, echo=FALSE, warning=FALSE, error=FALSE, message=FALSE}
# rm(list=ls())
...
pkgs = c("rclinicaltrials", "ggplot2", "plotly", "ggplotify", "rentrez",
         "tidytext", "reshape2", "bibliometrix",
         "RISmed", "ggthemes", "tibble", "httr", 
         "RCurl","data.table", "dplyr")
ipak(pkgs)
...
# library(httr)
# set_config(
#    use_proxy(url="http://proxy.charite.de", port=8080, username="bittlinm", password="hthUVd7qd6sck!")
# )
