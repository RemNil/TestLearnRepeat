...
How do we figure out how many clinical trials likely failed due to bad methodological [design](https://www.youtube.com/watch?v=hDcedskQy60)? While I was pondering the thought, I came up with the strem graph below. It shows the total amount pf püast experiences that we could use as research ethicists to learn from. If you have any idea or suggestion, please leave a comment using the annotation function on this website.
